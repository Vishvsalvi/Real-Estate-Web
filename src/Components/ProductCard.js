...
const ProductCard = ({ name, location, price, furnish_type, img }) => {
  return (
    <div>
   
  
   <div className="relative mx-auto w-full">
      <div href="/" className="cursor-pointer relative inline-block duration-300 ease-in-out transition-transform transform hover:-translate-y-2 w-full">
        <div className="shadow p-4 rounded-lg bg-white">
          ...
          <div className="mt-4">
            ...
            <p className="capitalize mt-2 text-sm text-gray-500 line-clamp-1 font-[poppins] " title="New York, NY 10004, United States">
              {location}
            </p>
            <p className='mt-2  ' >₹<span className="text-lg font-poppins">{price}</span>/m </p>
          </div>
  
          <div className="grid grid-cols-2 grid-rows-2 gap-4 mt-4">
            <p className="inline-flex flex-col xl:flex-row xl:items-center text-gray-800 font-poppins">
